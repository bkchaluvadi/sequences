...
stateDiagram-v2
    ...
    state Process {
        ...
        RunGCode --> PrecursorControl : abort/error Stop Precursor
        PrecursorControl --> ReactantControl : abort/error Stop Reactant
        ReactantControl --> InertGasControl : abort/error Stop Inert Gas
        InertGasControl --> HeatControl : abort/error Disable Heat
        HeatControl --> PositionControl : abort/error Move to Zero Position
    }
